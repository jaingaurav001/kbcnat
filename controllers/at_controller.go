...
import (
	...
	cnatv1alpha1 "github.com/jaingaurav001/kbcnat/api/v1alpha1"
	"github.com/jaingaurav001/kbcnat/pkg/schedule"
	"github.com/jaingaurav001/kbcnat/pkg/spawn"
)
...
// +kubebuilder:rbac:groups=cnat.kbdlr.rocks,resources=ats,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=cnat.kbdlr.rocks,resources=ats/status,verbs=get;update;patch
